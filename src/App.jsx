...
const CLINIC_INFO = {
  name: "MODERN SMILE",
  fullName: "Modern Smile dental clinic / مودرن سمايل",
  arabicName: "مودرن سمايل لطب الأسنان",
  subBrand: "SHARJAH ATELIER",
  address: "Kalba, Sharjah - UAE",
  phone: "+971 55 146 4976",
  email: "registry@modernsmile.ae",
...
const ServiceCard = ({ title, desc, img, index, icon }) => (
  <motion.div 
    ...
    className="group relative h-[450px] md:h-[600px] overflow-hidden cursor-pointer rounded-[40px] shadow-[2px_2px_2px_gray] bg-black"
  >
    ...
    <div className="absolute top-6 right-6 text-white/50 group-hover:text-[#C5A059] transition-colors duration-500">
      {icon}
    </div>
...
export default function App() {
  ...
  const handleRegistrySubmit = (e) => {
    ...
    const message = `*New Appointment Request - ${CLINIC_INFO.name}*\n\n` +
                    ...
                    `📱 Contact: ${contact}\n` +
                    `🏥 Service: ${service}\n\n` +
                    `Sent from Modern Smile Digital Atelier`;
    ...
    <div className="bg-[#FAF9F6] text-[#0A192F] font-sans selection:bg-[#C5A059] selection:text-white relative overflow-x-hidden">
      ...
      <nav className={`fixed top-0 left-0 w-full z-[100] transition-all duration-1000 ${isScrolled ? 'bg-white/95 backdrop-blur-xl py-3 shadow-sm border-b border-[#C5A059]/10' : 'bg-transparent py-6 md:py-10'}`}>
        <div className="container mx-auto px-6 md:px-10 flex justify-between items-center">
          <div className="flex flex-col group cursor-pointer text-center md:text-left">
            <span className={`text-xl md:text-2xl font-serif tracking-tighter transition-colors ${isScrolled ? 'text-[#0A192F]' : 'text-white'}`}>{CLINIC_INFO.name} DENTAL</span>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center">
              <span className="text-2xl font-serif">{CLINIC_INFO.name} DENTAL</span>
              <button onClick={() => setIsMenuOpen(false)} className="text-[#C5A059] p-2"><X size={32}/></button>
            </div>
            <div className="flex flex-col gap-6 text-center">
              {['Expertise', 'Gallery', 'Reviews', 'The Board', 'Appointment', 'Home'].map((item) => (
                <a key={item} href={`#${item.toLowerCase().replace(' ', '')}`} onClick={() => setIsMenuOpen(false)} className="text-4xl font-serif hover:italic hover:text-[#C5A059] transition-all">{item}</a>
              ))}
            </div>
            <div className="space-y-4 border-t border-white/10 pt-8 text-center text-white/70">
              ...
              <p className="text-[10px] uppercase leading-relaxed px-4">{CLINIC_INFO.address}</p>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      <section className="relative h-[90vh] md:h-screen flex items-center justify-center overflow-hidden bg-black text-center">
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          <LuxuryReveal delay={0.2}>
            <span className="inline-block text-[#C5A059] text-[8px] md:text-[10px] tracking-[0.8em] md:tracking-[1.5em] uppercase font-bold mb-4 md:mb-8">SHARJAH FLAGSHIP ATELIER</span>
          </LuxuryReveal>
          
          <LuxuryReveal delay={0.4}>
            <h1 className="text-4xl md:text-[110px] font-serif text-white font-light tracking-tighter leading-none mb-1 md:mb-2 uppercase">
              {CLINIC_INFO.name}
            </h1>
            <h2 className="text-xl md:text-[80px] font-serif gold-leaf font-light italic mb-8 md:mb-12 leading-none uppercase text-center">
              Dental Clinic
            </h2>
          </LuxuryReveal>

          <LuxuryReveal delay={0.6}>
             <p className="text-[18px] md:text-[34px] font-arabic text-[#E2D1B3] tracking-[0.05em] mb-12 opacity-90 leading-relaxed max-w-4xl mx-auto uppercase">
          ...
          <LuxuryReveal delay={0.8}>
            <div className="flex flex-col items-center gap-8 md:gap-12 pt-8 md:pt-16 border-t border-white/5">
              <p className="text-[#E2D1B3]/50 max-w-xl text-[10px] md:text-[14px] tracking-[0.3em] md:tracking-[0.5em] font-light leading-relaxed uppercase text-center">
                Bespoke Smile Excellence. <br />
                A biological sanctuary for aesthetic transformation in Sharjah.
              </p>
              
              <div className="flex flex-col sm:flex-row gap-4 md:gap-8 items-center justify-center w-full max-w-xs sm:max-w-none mx-auto">
                 <a href="#appointment" className="px-10 md:px-16 py-4 md:py-6 bg-[#C5A059] text-white text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em] shadow-2xl rounded-full hover:bg-white hover:text-[#0A192F] transition-all w-full sm:w-auto text-center">
                   Book Appointment
                 </a>
                 <a href={`https://wa.me/${CLINIC_INFO.phone.replace(/\D/g, '')}`} target="_blank" rel="noreferrer" className="px-10 md:px-12 py-4 md:py-6 border border-white/20 backdrop-blur-md text-white text-[9px] md:text-[10px] font-bold uppercase tracking-[0.4em] flex items-center gap-3 rounded-full hover:bg-white/10 transition-all w-full sm:w-auto justify-center">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-12 gap-12 md:gap-20 items-center">
            <div className="col-span-12 lg:col-span-5 order-2 lg:order-1 text-center lg:text-left">
              ...
              <p className="text-gray-500 text-base md:text-xl font-light leading-loose mb-10 md:mb-12 max-w-lg mx-auto lg:mx-0">
                Located in the heart of Sharjah at {CLINIC_INFO.address}, {CLINIC_INFO.fullName} is where clinical precision meets unparalleled luxury in specialized dentistry and oral restoration.
              </p>
              <div className="grid grid-cols-2 gap-4 md:gap-12">
                 {[
                   { t: "Elite Tech", i: <Microscope size={20}/> },
                   { t: "Restoration", i: <Zap size={20}/> },
                   { t: "Board Experts", i: <Award size={20}/> },
                   { t: "Precision", i: <Activity size={20}/> }
                 ].map((item, i) => (
                   <div key={i} className="flex flex-col gap-3 p-4 md:p-8 bg-[#FAF9F6] rounded-[40px] shadow-[2px_2px_2px_gray] border border-gray-50 text-center lg:text-left">
      ...
      <section id="expertise" className="py-24 md:py-60 bg-[#0A192F] text-white">
        <div className="container mx-auto px-6 md:px-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
             <ServiceCard title="Implantology" desc="Molecular level alignment and structural harmony." img={IMAGES.service1} index={0} icon={<Activity size={32}/>} />
             <ServiceCard title="Smile Design" desc="Advanced veneers and aesthetic refinement." img={IMAGES.service2} index={1} icon={<Zap size={32}/>} />
             <ServiceCard title="Diagnostics" desc="Comprehensive 3D radiological health mapping." img={IMAGES.service3} index={2} icon={<Microscope size={32}/>} />
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 md:py-60 bg-white">
        <div className="container mx-auto px-6 md:px-10">
          <SectionHeader number="03" title="Find Us" subtitle="Sharjah Headquarters" />
              ...
              <div className="p-8 md:p-12 bg-[#FAF9F6] rounded-[40px] shadow-[2px_2px_15px_gray] border border-gray-100 flex flex-col justify-center h-full">
                <div className="space-y-12">
                  <div className="flex gap-6 items-start">
                    ...
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#0A192F] mb-3">Address - العنوان</p>
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#0A192F] mb-3">Concierge - اتصل بنا</p>
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-[0.4em] text-[#0A192F] mb-3">Hours - ساعات العمل</p>
              ...
              <div className="h-full min-h-[400px] bg-gray-100 rounded-[40px] shadow-[2px_2px_15px_gray] overflow-hidden relative grayscale group hover:grayscale-0 transition-all duration-1000">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                   <div className="bg-white/90 backdrop-blur-md p-8 rounded-[30px] shadow-2xl text-center max-w-xs mx-4">
                      ...
                      <h4 className="text-lg font-serif text-[#0A192F] mb-2">{CLINIC_INFO.name} DENTAL</h4>
      ...
      <section id="gallery" className="py-24 md:py-60 bg-[#0A192F] text-white relative overflow-hidden">
        <div className="container mx-auto px-6 md:px-10">
          <SectionHeader number="04" title="The Gallery" subtitle="Visual Excellence - معرض الصور" light />
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6">
             <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="md:col-span-2 md:row-span-2 h-[300px] md:h-[624px] rounded-[30px] md:rounded-[40px] overflow-hidden group shadow-[2px_2px_15px_black]">
                <img src={IMAGES.hero} alt="Gallery 1" className="w-full h-full object-cover grayscale-[20%] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" />
             </motion.div>
             <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="h-[300px] rounded-[30px] md:rounded-[40px] overflow-hidden group shadow-[2px_2px_15px_black]">
                <img src={IMAGES.service1} alt="Gallery 2" className="w-full h-full object-cover grayscale-[20%] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" />
             </motion.div>
             <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.2 }} className="h-[300px] rounded-[30px] md:rounded-[40px] overflow-hidden group shadow-[2px_2px_15px_black]">
                <img src={IMAGES.service2} alt="Gallery 3" className="w-full h-full object-cover grayscale-[20%] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" />
             </motion.div>
             <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.3 }} className="md:col-span-2 h-[300px] rounded-[30px] md:rounded-[40px] overflow-hidden group shadow-[2px_2px_15px_black]">
                <img src={IMAGES.about} alt="Gallery 4" className="w-full h-full object-cover grayscale-[20%] group-hover:grayscale-0 group-hover:scale-105 transition-all duration-1000" />
             </motion.div>
          </div>
        </div>
      </section>

      {/* --- Section 05: Client Reviews --- */}
      <section id="reviews" className="py-24 md:py-60 bg-white">
        <div className="container mx-auto px-6 md:px-10">
          <SectionHeader number="05" title="Client Voices" subtitle="Testimonials - آراء العملاء" />
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
             {[
               { name: "Sarah L.", text: "Exceptional service and a truly luxurious experience. Dr. Ahmed and his team are masters of their craft.", textAr: "خدمة استثنائية وتجربة فاخرة حقاً. الفريق الطبي هنا هم أسياد مهنتهم." },
               { name: "Mohammed R.", text: "The Hollywood Smile procedure changed my life. The clinic feels like a 5-star hotel with the best care.", textAr: "إجراء ابتسامة هوليوود غير حياتي. العيادة تبدو وكأنها فندق 5 نجوم مع أفضل رعاية." },
               { name: "Elena V.", text: "Painless, professional, and pristine. Highly recommended for anyone looking for premium dental care in Sharjah.", textAr: "بدون ألم، احترافية، ونظافة تامة. يوصى به بشدة لأي شخص يبحث عن رعاية أسنان متميزة في الشارقة." }
             ].map((review, i) => (
               <motion.div 
                 key={i}
                 initial={{ opacity: 0, y: 50 }}
                 ...
                 className="bg-[#FAF9F6] p-8 md:p-12 rounded-[40px] shadow-[2px_2px_15px_gray] border border-gray-100 flex flex-col justify-between group hover:-translate-y-2 transition-transform duration-500"
               >
                 <div>
                   <Quote className="text-[#C5A059] opacity-30 mb-6 w-12 h-12" />
                   <p className="text-gray-500 font-light leading-relaxed mb-6 text-sm md:text-base italic">"{review.text}"</p>
                   <p className="text-gray-400 font-arabic leading-relaxed mb-8 text-sm md:text-base">"{review.textAr}"</p>
                 </div>
                 <div>
                   <div className="flex gap-1 mb-4">
                     {[...Array(5)].map((_, starIndex) => (
                       <Star key={starIndex} size={14} className="text-[#C5A059] fill-[#C5A059]" />
                     ))}
                   </div>
                   <h4 className="text-[11px] font-bold uppercase tracking-widest text-[#0A192F]">{review.name}</h4>
                   <p className="text-[8px] text-gray-400 uppercase tracking-[0.2em] mt-1">Verified Patient - مريض موثق</p>
                 </div>
               </motion.div>
             ))}
          </div>
      ...
      <section id="theboard" className="py-24 md:py-60 bg-[#FAF9F6] text-center md:text-left">
        <div className="container mx-auto px-6 md:px-10 text-center mb-12 md:mb-32">
          <SectionHeader number="06" title="Medical Board" subtitle="Authority" />
          <p className="text-gray-400 text-sm md:text-xl font-light leading-relaxed max-w-2xl mx-auto text-center">
            Our clinical specialists are leaders dedicated to your smile transformation and vitality.
          </p>
        </div>
        <div className="container mx-auto px-6 md:px-10">
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
              <div className="p-8 md:p-12 bg-white rounded-[40px] shadow-[2px_2px_2px_gray] border border-gray-100 text-center group transition-all">
                 ...
                 <p className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-[#C5A059] mb-2">Lead Clinician</p>
                 <h4 className="text-xl md:text-3xl font-serif text-[#0A192F]">Expert Board</h4>
              </div>
              <div className="p-8 md:p-12 bg-white rounded-[40px] shadow-[2px_2px_2px_gray] border border-gray-100 text-center group transition-all">
                 <div className="rounded-2xl overflow-hidden mb-6 md:mb-10 h-64 md:h-80">
                 ...
                 <h4 className="text-xl md:text-3xl font-serif text-[#0A192F]">Expert Panel</h4>
              </div>
              <div className="p-8 md:p-16 bg-[#0A192F] rounded-[40px] shadow-[2px_2px_15px_gray] flex flex-col justify-center text-center text-white">
                 ...
                 <h5 className="text-lg md:text-2xl font-serif mb-4 md:mb-8 uppercase tracking-widest text-center">Governance</h5>
                 <p className="text-[10px] md:text-[11px] text-gray-400 uppercase tracking-widest leading-loose italic text-center">
      ...
      <section id="appointment" className="py-24 md:py-72 bg-white relative">
         <div className="container mx-auto px-6 md:px-10">
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-32">
               <div className="lg:w-2/5 flex flex-col justify-center text-center lg:text-left">
                  ...
                  <p className="text-gray-500 font-light text-lg md:text-2xl leading-relaxed mb-4 md:mb-8">
                    Your journey to a star-level smile begins here. Once submitted, your request will be sent to our WhatsApp concierge.
                  </p>
                  <p className="text-gray-500 font-arabic text-xl mb-10 md:mb-16">
                    رحلتك نحو ابتسامة النجوم تبدأ من هنا. بمجرد الإرسال، سيتم إرسال طلبك إلى خدمة الكونسيرج عبر الواتساب.
                  </p>
                  ...
                  <div className="p-8 bg-[#FAF9F6] rounded-[40px] shadow-sm mb-12 border border-gray-50 text-left">
                    <div className="flex items-center gap-4 mb-4">
                      ...
                      <p className="text-[10px] font-bold uppercase tracking-widest text-[#0A192F]">Sharjah Centre - مركز الشارقة</p>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
                     <div className="flex gap-4 p-6 bg-[#FAF9F6] rounded-[25px] shadow-sm">
                        ...
                        <div className="text-left">
                           <p className="text-[9px] uppercase font-bold text-[#0A192F]">Secure Channel - قناة آمنة</p>
                     ...
                     <div className="flex gap-4 p-6 bg-[#FAF9F6] rounded-[25px] shadow-sm">
                        ...
                        <div className="text-left">
                           <p className="text-[9px] uppercase font-bold text-[#0A192F]">Fast Response - استجابة سريعة</p>
                           <p className="text-[10px] text-gray-400 leading-tight">Concierge review within 1h.</p>
                        </div>
                     </div>
                  </div>
               </div>
                     ...
                     <AnimatePresence mode="wait">
                        {registryStatus === 'success' ? (
                           <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-center py-10">
                              ...
                              <h3 className="text-2xl font-serif mb-4 text-[#0A192F]">Message Generated</h3>
                              <p className="text-gray-500 text-sm mb-8">Please complete the send process in WhatsApp.</p>
                              <button onClick={() => setRegistryStatus('idle')} className="text-[#C5A059] text-[10px] font-bold uppercase tracking-widest border-b border-[#C5A059] pb-1">New Request - طلب جديد</button>
                           </motion.div>
                        ) : (
                           <form onSubmit={handleRegistrySubmit} className="space-y-8 md:space-y-12">
                              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-12">
                                 <div className="relative">
                                    <label className="text-[8px] uppercase tracking-widest text-gray-400 mb-1 block">Full Identity - الاسم الكامل</label>
                                    <input name="fullName" required type="text" className="premium-input text-sm" placeholder="e.g. John Doe" />
                                 </div>
                                 <div className="relative">
                                    <label className="text-[8px] uppercase tracking-widest text-gray-400 mb-1 block">Contact Point - رقم التواصل</label>
                                    <input name="contactPoint" required type="text" className="premium-input text-sm" placeholder="Email/Phone" />
                                 </div>
                              </div>
                              <div className="relative">
                                 <label className="text-[8px] uppercase tracking-widest text-gray-400 mb-1 block">Service - الخدمة المطلوبة</label>
                                 <select name="specialization" className="premium-input text-sm appearance-none bg-transparent">
                                    <option>Smile Reconstruction - بناء الابتسامة</option>
                                    <option>Aesthetic Veneers - فينير تجميلي</option>
                                    <option>Dental Implants - زراعة أسنان</option>
                                    <option>Orthodontic Consultation - استشارة تقويم</option>
                                 </select>
                              </div>
                              <button type="submit" className="w-full py-5 md:py-8 bg-[#0A192F] text-[#E2D1B3] rounded-full uppercase tracking-widest font-bold text-[10px] hover:bg-[#C5A059] transition-all shadow-xl text-center flex items-center justify-center gap-3">
                                 {registryStatus === 'submitting' ? 'Preparing WhatsApp...' : 'Confirm via WhatsApp - تأكيد عبر واتساب'}
      ...
      <footer className="bg-[#FAF9F6] py-16 md:py-40 relative border-t border-gray-100">
         <div className="container mx-auto px-6 md:px-10 text-center md:text-left">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-20 mb-24">
               <div className="space-y-6 md:space-y-10">
                  <div className="flex flex-col group cursor-pointer">
                     <span className="text-xl md:text-3xl font-serif text-[#0A192F]">{CLINIC_INFO.name} DENTAL</span>
                     <span className="text-[8px] md:text-[11px] tracking-widest font-bold text-[#C5A059] uppercase">The Atelier</span>
                  </div>
                  <p className="text-gray-400 text-xs leading-loose uppercase tracking-widest">The pinnacle of dental health in Sharjah.</p>
               </div>
               
               <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#C5A059] mb-6 md:mb-10 text-center md:text-left">Location</h4>
                  <ul className="space-y-4">
                    ...
                    <li className="flex flex-col md:flex-row gap-4 items-center">
               ...
               <div>
                  <h4 className="text-[10px] uppercase tracking-widest font-bold text-[#C5A059] mb-6 md:mb-10 text-center md:text-left">Atelier</h4>
                  <ul className="space-y-4 text-[10px] text-gray-400 font-bold uppercase tracking-widest text-center md:text-left">
         ...
         <div className="absolute bottom-0 right-0 p-20 opacity-[0.01] text-[20vw] font-serif select-none pointer-events-none uppercase">{CLINIC_INFO.name.split(' ')[0]}</div>
      </footer>
      ...
      >
        <div className="p-2 md:p-4 bg-[#25D366] rounded-full text-white shadow-xl group-hover:scale-110 transition-transform text-center"><MessageCircle size={20}/></div>
        <span className="hidden md:inline text-[11px] font-bold uppercase tracking-[0.5em] pr-4 group-hover:text-white text-center">WhatsApp Concierge</span>
      </a>
      ...
      <div className="fixed bottom-6 right-6 z-[90]">
            ...
            >
               <div className="bg-[#0A192F] p-8 md:p-10 text-white flex justify-between items-center relative overflow-hidden">
                  <div className="flex items-center gap-4 relative z-10">
                     <div className="w-14 h-14 border border-[#C5A059] rounded-full flex items-center justify-center italic font-serif text-[#C5A059] text-2xl uppercase">{CLINIC_INFO.name[0]}</div>
                     <div>
                        <h6 className="text-[11px] font-bold uppercase tracking-widest text-center">Assistant</h6>
                        <p className="text-[8px] text-[#C5A059] uppercase tracking-[1em] animate-pulse text-center">Online</p>
                     </div>
                  </div>
                  <button onClick={() => setIsChatOpen(false)} className="opacity-40 hover:opacity-100 transition-opacity p-1"><X size={28}/></button>
               </div>
               <div className="p-10 h-[300px] md:h-[400px] bg-[#FAF9F6] overflow-y-auto space-y-8 text-sm font-light leading-loose italic text-gray-500 text-center">
                  "Welcome to the {CLINIC_INFO.fullName} private circle. How may I assist your booking request today?"
               </div>
               <div className="p-8 bg-white border-t border-gray-50 flex gap-4 items-center">
                  ...
                  <button className="text-[#C5A059] hover:scale-125 transition-transform p-1"><Send size={24}/></button>
               </div>
            </motion.div>
          )}
        </AnimatePresence>
        ...
        >
          <span className="hidden md:inline text-[11px] font-bold uppercase tracking-[0.5em] text-center">{isChatOpen ? 'Close' : 'Atelier Assistant'}</span>
          <Fingerprint size={28}/>
        </button>
      </div>
